      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 px-6 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="mt-12 lg:mt-0 lg:pl-10">
          ...
          <h2
            data-aos="fade-up"
            data-aos-delay="80"
            className="mb-6 text-[30px] font-bold leading-[1.2] text-[var(--sowa-ink)] md:text-[42px]"
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="120"
            className="mb-8 max-w-xl text-sm leading-relaxed text-[var(--sowa-ink-muted)] md:text-base"
          >
